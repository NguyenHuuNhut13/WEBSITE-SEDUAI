...
export default function Footer() {
  ...
  return (
    <footer className="bg-slate-900 text-slate-400 relative">
      ...
      <button
        onClick={scrollToTop}
        className={`fixed z-40 transition-all duration-500 rounded-none bg-gradient-to-tr from-primary to-blue-600 text-white shadow-lg shadow-primary/30 flex items-center justify-center hover:scale-110 hover:shadow-primary/50 cursor-pointer animate-glow-border w-14 h-14 ${
