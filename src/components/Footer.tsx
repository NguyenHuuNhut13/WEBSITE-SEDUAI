...
import { Brain, MapPin, Phone, Mail, ArrowRight, ChevronUp } from 'lucide-react';
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400">
                  Đăng ký email để nhận ưu đãi khóa học và sự kiện sắp tới.
                </p>
              </div>
            </div>
            <div className="flex w-full lg:w-auto max-w-md bg-slate-900 rounded-xl overflow-hidden border border-slate-700">
              <input
                type="email"
                placeholder="Nhập email của bạn..."
                className="flex-grow px-4 py-3 bg-transparent text-white placeholder-slate-500 focus:outline-none text-sm"
              />
              <button className="px-5 py-3 bg-primary hover:bg-primary-dark text-white font-bold text-xs transition-colors duration-200 flex items-center gap-1.5 cursor-pointer flex-shrink-0">
